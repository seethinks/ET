...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ProtobufHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ToStream_0);


        }


        static StackObject* ToStream_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ProtobufHelper.ToStream(@message, @stream);
